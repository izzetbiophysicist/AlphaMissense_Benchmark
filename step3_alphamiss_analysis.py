...
def plot_prediction_by_review(df, review_st=None, date_cutoff=None, date_type='prev', strict=False, approximate_clinvar=False, by_GO=False):
#### Filter dataframe
    ...
    if approximate_clinvar:
        for i in range(len(filtered_df)):
            ...
            elif value in ['Benign/Likely benign', 'Likely benign', 'Benign']:
...
for cut in range(2008, 2023):
    result = plot_prediction_by_review(df, review_st=None, date_cutoff=cut, date_type='post', strict=True)
...
sizes_approximate = []
for cut in range(2008, 2023):
    result = plot_prediction_by_review(df, review_st=None, date_cutoff=cut, date_type='post', strict=True, approximate_clinvar=True)
...
###  Accordance by GO
############
result = plot_prediction_by_review(df, review_st=None, date_cutoff=None, date_type='post', strict=True, approximate_clinvar=True)
